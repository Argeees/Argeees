...
<table align="center" style="border: none;">
  <tr>
    ...
    <td width="60%">
      <h4><code>arges@github:~$ whoami</code></h4>
      <p>
        👤 <b>Nombre:</b> Arges Martinez Chavez<br>
        📍 <b>Ubicación:</b> Querétaro, México<br>
        🎓 <b>Educación:</b> Universidad Autónoma de Querétaro (UAQ)<br>
        💻 <b>Rol:</b> Estudiante de Ing. de Software y Desarrollador Web
      </p>
      <p>
      ...
      <p>
        <b>> Intereses & Hobbies:</b><br>
        ⚡ Hardware de PC (Ryzen 7 5700x / RTX 5070) & Audio Hi-Fi<br>
        🎮 Gaming Competitivo (osu!, Rainbow Six Siege)<br>
        🎨 Creación de arte estilo anime y diseño de personajes
      </p>
    </td>
  </tr>
</table>
